      ...
      <div className="game-level-content">
        ...
        <div className="game-level-options">
          ...
          >
            ...
            <div className="game-level-button-description">20 seconds per letter</div>
          </button>
          <button
          ...
          >
            ...
            <div className="game-level-button-description">10 seconds per letter</div>
          </button>
          <button
          ...
          >
            ...
            <div className="game-level-button-description">5 seconds per letter</div>
          </button>
        </div>
      </div>
    </div>
